...
class MathList extends StatefulWidget {
  String name = '';
  MathList(this.name);

  @override
  _MathListState createState() => _MathListState(name);
}

class _MathListState extends State<MathList> {
  ...
  String listOfChoice1 = 'mathList1';
  String listOfChoice2 = 'mathList2';
  String listOfChoice3 = 'mathList3';
  String listOfChoice4 = 'mathList4';

  String name = '';
  String lName = 'mathList';
  double wrongScorePer = 0.0;
  double wrongAnsPer = 0.0;
  double correctScorePer = 0.0;
  double correctAnsPer = 0.0;

  _MathListState(this.name);
  int totalScore = 0;
  int correctAns = 0;
  int wrongAns = 0;
