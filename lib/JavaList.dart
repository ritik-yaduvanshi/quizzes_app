...
class JavaList extends StatefulWidget {

  String name = '';
  JavaList(this.name);
  @override
  _JavaListState createState() => _JavaListState(name);
}

class _JavaListState extends State<JavaList> {
  ...
  String listOfChoice1 = 'javaList1';
  String listOfChoice2 = 'javaList2';
  String listOfChoice3 = 'javaList3';
  String listOfChoice4 = 'javaList4';

  String name = '';
  String lName = 'javaList';
  double wrongScorePer = 0.0;
  double wrongAnsPer = 0.0;
  double correctScorePer = 0.0;
  double correctAnsPer = 0.0;

  _JavaListState(this.name);
