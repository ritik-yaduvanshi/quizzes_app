...
import 'package:quizzes/ScoreCard.dart';

import 'Texts.dart';
class Cprogram extends StatefulWidget {
  String name = '';
  Cprogram(this.name);

  @override
  _CprogramState createState() => _CprogramState(name);
}

class _CprogramState extends State<Cprogram> {
  Texts text = new Texts();
  QuestionBank ques = new QuestionBank();
  int round = 0;

  //list Name of choices
  String listOfChoice1 = 'list1';
  String listOfChoice2 = 'list2';
  String listOfChoice3 = 'list3';
  String listOfChoice4 = 'list4';

  String name = '';
  String lName = 'CquesList';
