...
class JsList extends StatefulWidget {

  String name = '';
  JsList(this.name);
  @override
  _JsListState createState() => _JsListState(name);
}

class _JsListState extends State<JsList> {
  ...
  String listOfChoice1 = 'jsList1';
  String listOfChoice2 = 'jsList2';
  String listOfChoice3 = 'jsList3';
  String listOfChoice4 = 'jsList4';
