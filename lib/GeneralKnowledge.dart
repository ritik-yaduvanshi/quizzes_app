...
class GeneralKnowledge extends StatefulWidget {
  String name ='';
  GeneralKnowledge(this.name);

  @override
  _GeneralKnowledgeState createState() => _GeneralKnowledgeState(name);
}
...
class _GeneralKnowledgeState extends State<GeneralKnowledge> {
  ...
  String listOfChoice1 = 'gkList1';
  String listOfChoice2 = 'gkList2';
  String listOfChoice3 = 'gkList3';
  String listOfChoice4 = 'gkList4';
  ...
  _GeneralKnowledgeState(this.name);
  String resultMaker(){
    String results = '';
    if(totalScore >=8){
