...
class PhysicsList extends StatefulWidget {
  String name = '';
  PhysicsList(this.name);
  @override
  _PhysicsListState createState() => _PhysicsListState(name);
}

class _PhysicsListState extends State<PhysicsList> {
  ...
  String listOfChoice1 = 'physicsList1';
  String listOfChoice2 = 'physicsList2';
  String listOfChoice3 = 'physicsList3';
  String listOfChoice4 = 'physicsList4';

  String name = '';
  String lName = 'physicsList';
  double wrongScorePer = 0.0;
  double wrongAnsPer = 0.0;
  double correctScorePer = 0.0;
  double correctAnsPer = 0.0;

  _PhysicsListState(this.name);
