...
class PythonList extends StatefulWidget {
  String name ='';
  PythonList(this.name);
  @override
  _PythonListState createState() => _PythonListState(name);
}

class _PythonListState extends State<PythonList> {
  ...
  String listOfChoice1 = 'pythonList1';
  String listOfChoice2 = 'pythonList2';
  String listOfChoice3 = 'pythonList3';
  String listOfChoice4 = 'pythonList4';

  String name = '';
  String lName = 'pythonList';
  double wrongScorePer = 0.0;
  double wrongAnsPer = 0.0;
  double correctScorePer = 0.0;
  double correctAnsPer = 0.0;

  _PythonListState(this.name);
