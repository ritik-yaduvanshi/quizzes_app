...
class Chemistry extends StatefulWidget {
  ...
  String userName = '';
  Chemistry(this.userName);

  @override
  _ChemistryState createState() => _ChemistryState(userName);
}
...
class _ChemistryState extends State<Chemistry> {
  ...
  String listOfChoice1 = 'chemList1';
  String listOfChoice2 = 'chemList2';
  String listOfChoice3 = 'chemList3';
  String listOfChoice4 = 'chemList4';

  String name = '';
  String lName = 'chemList';
